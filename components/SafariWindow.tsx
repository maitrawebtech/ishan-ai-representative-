...
export default function SafariWindow({ onClose }: SafariWindowProps) {
  ...
  const handleUrlSubmit = (e: React.FormEvent) => {
    ...
    } else if (query.toLowerCase().includes('github.com/ishan') || query.toLowerCase() === 'github') {
      navigateTo('github', 'https://github.com/maitrawebtech');
    } else if (query.toLowerCase().includes('linkedin.com') || query.toLowerCase() === 'linkedin') {
      navigateTo('linkedin', 'https://linkedin.com/in/ishan-maitra');
    } else {
        ...
        {currentTab === 'start' && (
          <div className="flex-1 flex flex-col items-center justify-center p-8 bg-gradient-to-b from-[#1c1c1e] to-[#121214]">
            ...
            <div className="grid grid-cols-4 gap-8 max-w-lg w-full">
              ...
              {/* GitHub Link */}
              <div
                onClick={() => window.open('https://github.com/maitrawebtech', '_blank')}
                className="flex flex-col items-center gap-2 cursor-pointer group"
              >
              ...
              {/* LinkedIn Link */}
              <div
                onClick={() => window.open('https://linkedin.com/in/ishan-maitra', '_blank')}
                className="flex flex-col items-center gap-2 cursor-pointer group"
              >
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-8 bg-[#202124] text-white">
            ...
            <form onSubmit={handleGoogleSearch} className="w-full max-w-xl">
              ...
              <div className="flex justify-center gap-3 mt-8">
                ...
                <button
                  type="button"
                  onClick={() => { setSearchQuery('Ishan Maitra portfolio'); navigateTo('google-results', 'https://www.google.com/search?q=ishan+Kushwaha+portfolio'); }}
          ...
          <div className="flex-1 bg-[#202124] text-white p-6 flex flex-col font-sans select-text">
            ...
            <div className="flex items-center gap-4 pb-4 border-b border-[#303134] mb-4">
              ...
              <div className="bg-[#303134] rounded-full px-4 py-1.5 text-xs text-white/80 w-80">
                {searchQuery || 'Ishan Maitra portfolio'}
              </div>
            </div>
            ...
            <div className="mb-6 max-w-xl">
              <span className="text-[11px] text-white/50 block">ishan-maitra.dev</span>
              <h3
              ...
              >
                Ishan Maitra | AI Developer & Creative Portfolio
              </h3>
            ...
            <div className="mb-6 max-w-xl">
              <span className="text-[11px] text-white/50 block">github.com › maitrawebtech</span>
              <h3
                onClick={() => window.open('https://github.com/maitrawebtech', '_blank')}
                className="text-sky-400 hover:underline cursor-pointer text-lg font-medium leading-tight mt-0.5"
              >
                maitrawebtech (Ishan Maitra) · GitHub
              </h3>
              <p className="text-xs text-white/70 mt-1 leading-normal">
                Ishan Maitra - AI Developer. Code repositories for Nike Store application, AI Resume Analyzer, and other Next.js/React side projects.
              </p>
            </div>

            {/* Result 3: LinkedIn Profile */}
            <div className="mb-6 max-w-xl">
              <span className="text-[11px] text-white/50 block">linkedin.com › in › ishan-maitra</span>
              <h3
                onClick={() => window.open('https://linkedin.com/in/ishan-maitra', '_blank')}
                className="text-sky-400 hover:underline cursor-pointer text-lg font-medium leading-tight mt-0.5"
              >
                Ishan Maitra - AI Developer - LinkedIn
              </h3>
              <p className="text-xs text-white/70 mt-1 leading-normal">
                View Ishan Maitra's professional profile on LinkedIn. Connecting technologies, languages, backend APIs, and React architectures to drive engineering value.
              </p>
            </div>
          </div>
        )}
        ...
        {currentTab === 'github' && (
          <div className="flex-1 bg-[#0d1117] text-[#c9d1d9] font-sans p-6 select-text flex flex-col">
            ...
            <div className="flex items-center justify-between pb-4 border-b border-[#21262d] mb-6">
              ...
              <button onClick={() => window.open('https://github.com/maitrawebtech', '_blank')} className="px-3 py-1 bg-[#21262d] hover:bg-[#30363d] rounded text-xs font-semibold text-[#c9d1d9] border border-[#30363d]">
                Open in Github
              </button>
            </div>
            ...
            <div className="flex gap-6">
              ...
              <div className="w-1/3 flex flex-col items-center">
                ...
                <h2 className="text-xl font-bold text-[#f0f6fc]">Ishan Maitra</h2>
                <span className="text-sm text-[#8b949e]">maitrawebtech</span>
                <p className="text-xs text-[#8b949e] mt-4 text-center">
                  AI Developer | Building interactive applications with JavaScript, React, & Node.js.
                </p>
              </div>
          ...
          <div className="flex-1 bg-[#f3f3f3] text-neutral-800 font-sans p-6 select-text flex flex-col justify-center items-center">
            ...
            <div className="w-full max-w-md bg-white border border-neutral-200 rounded-xl overflow-hidden shadow-md">
              ...
              <div className="px-6 pb-6 relative flex flex-col items-center">
                ...
                <h2 className="text-lg font-bold text-neutral-800">Ishan Maitra</h2>
                <p className="text-xs text-neutral-500 text-center font-medium mt-0.5">I would called my self AI Developer</p>
                ...
                <div className="w-full">
                  ...
                  <div className="flex gap-3 mb-3">
                    ...
                    <div>
                      <h4 className="text-xs font-bold text-neutral-800">AI Developer</h4>
