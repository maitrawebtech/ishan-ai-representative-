    ...
    <div className={styles.terminal}>
      ...
      <div className={styles.content}>
        <div className={styles.prompt}>
          <span className={styles.user}>@Ishan</span> % show tech stack
        </div>
        ...
        <table className={styles.techTable}>
          ...
          <tbody>
            <tr>
              ...
              <td>Python, Kotlin, TypeScript, Java, C++</td>
            </tr>
            <tr>
              <td className={styles.category}><span className={styles.check}>✓</span> Frontend / Mobile</td>
              <td>Jetpack Compose, React.js, HTML/CSS</td>
            </tr>
            <tr>
              <td className={styles.category}><span className={styles.check}>✓</span> AI / ML</td>
              <td>NumPy, SciPy, MediaPipe, OpenCV</td>
            </tr>
            <tr>
              <td className={styles.category}><span className={styles.check}>✓</span> Cloud & DevOps</td>
              <td>Google Cloud (GCP), Docker, CI/CD</td>
            </tr>
            <tr>
              <td className={styles.category}><span className={styles.check}>✓</span> Database</td>
              <td>Room, ChromaDB, SQL</td>
            </tr>
            <tr>
